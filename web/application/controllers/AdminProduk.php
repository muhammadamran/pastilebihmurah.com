...
class AdminProduk extends CI_Controller {
	...
	public function create()
	{
		...
		$this->M_Master->input_aplikasi('tb_aplikasi', $data);
		redirect('AdminProduk', $data);
	}
	...
	public function update($id)
	{
		...
		{	
			...
			$this->M_Master->update_aplikasi('tb_aplikasi',$data, $id);
		} 
		redirect('AdminProduk');	
	}
	...
	public function updatefotopj($id){
		...
		if($this->upload->do_upload("cover")){
			...
			$result= $this->M_Master->update_aplikasi('tb_aplikasi',$data, $id);
	...
	public function delete(){
		...
		$this->M_Master->DeleteDataAplikasi('tb_aplikasi',$id);
