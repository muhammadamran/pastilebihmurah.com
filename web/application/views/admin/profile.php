							...
							<div class="card-body">
								<div class="table-responsive">
									<table id="example" class="table table-striped table-bordered second" style="width:100%">
										...
										<tbody>
											<?php
											$con=mysqli_connect("localhost","root","","db_pastilebihmurah");
																	...
																	<form method="post" action="">
																		<div class="form-group">
																			...
																			<div align="center">
																				...
																				<?php }else{ ?>
																					<img src="<?php echo base_url().'assets/images/logo/'. $row['icon'];?>" class="lingkaran3" alt="User profile picture">   
																				<?php } ?>
																			</div>
																			<br>
																			<hr>
																			<div align="center">
																				...
																				<?php }else{ ?>
																					<img src="<?php echo base_url().'assets/images/brand/'. $row['logo'];?>" class="lingkaran3" alt="User profile picture">   
																				<?php } ?>
																			</div>
																			<hr>
