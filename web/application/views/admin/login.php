...
<html lang="en">
<head>
	<title>pastilebihmurah.com - Admin Panel</title>
			...
			<div class="wrap-login100">
				<form class="login100-form validate-form" method="POST" action="<?php echo base_url() ?>index.php/AdminLogin/aksi_login">
					<span class="login100-form-title p-b-34">
						Login Admin Panel<hr><br><h5 class="txt2">pastilebihmurah.com</h5>
					</span>
				...
				<div class="login100-more" style="background-image: url(<?php echo base_url('template/login/images/login.png');?>"></div>
			</div>
		</div>
	</div>
